//Egyedi, még nem létező report futtatása egy oldalról.
pageextension 50098 SEIFinishedWOPageExt extends "Finished Production Order"
{
    actions
    {
        addfirst("O&rder") // aminek a végéhez hozzátennénk
        {
            action("Consumption summary") // saját elnevezés, pl.: "PrintReport"
            {
                ApplicationArea = All;
                ...
                begin
                    ...
                    ProductionOrder_50099.SetRange(ProductionOrder_50099."No.", Rec."No."); //Rec, az a record, amelyen a user áll, mindig az aktuális adatokat adja vissza
