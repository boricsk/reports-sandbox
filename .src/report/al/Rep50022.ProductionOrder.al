report 50022 "SEI Production Order 0P"
{
    DefaultLayout = RDLC;
    RDLCLayout = '.src/report/rdlc/Rep50022.ProductionOrder.rdlc';
    ApplicationArea = Manufacturing;
    Caption = 'SEI Production Order 0P';
            ...
            dataitem("Prod. Order Line"; "Prod. Order Line")
            {
                ...
                dataitem("Prod. Order Routing Line"; "Prod. Order Routing Line")
                {
                    ...
                    dataitem(CompLink; "Prod. Order Component")
                    {
                        ...
                        column(BarCodeCompLinkRMNo; C128WOCompLinkRMItem.Picture) { }

                        trigger OnAfterGetRecord()
                        begin

                            C128WOCompLinkRMItem.Init();
                            C128MakeBarcode(Format("Item No."), C128WOCompLinkRMItem, 3000, 1000, 96, false);
                        end;
    ...
    labels
    {
        ...
        LblUnit = 'Unit';
        LblGoodGty = 'Good qty';
        LblOpTime = 'Operation time';
        LblDate = 'Date';
        LblMachNo = 'Machine no.';
        LblName = 'Name';
        LblShift = 'Shift';
        LblScrapQty = 'Scrap Qty';
        LblScrapCode = 'Scrap code';
        LblStopTime = 'Stop time';
        LblStopCode = 'Stop code';
    ...
    var
        ...
        C128WOCompLinkRMItem: Record "Company Information";
        C128WOItemNumber: Record "Company Information";

    local procedure C128WriteBarcode(Strm: OutStream; C128ID: Integer)
    var
        ch: Byte;
        j: Integer;
