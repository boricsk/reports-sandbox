// //Jelentéskiválasztás esetén a beállított setrange-eket ki kell szedni mert a jelentés kiválasztásakor a rekordra rárakja a bizonylatszám szerinti
// //szűrést. Ez a verzió a form-ról indítható verzió, a temporary file-ban a standalone verzió van meghagyva.

// report 50020 "Production Order Finished"
// {
//     Caption = 'Production Order Finished';

//     ApplicationArea = All;
//     UsageCategory = ReportsAndAnalysis;
//     DefaultLayout = RDLC;
//     RDLCLayout = '.src/report/rdlc/Rep50020.ProductionOrder.rdlc';
//     dataset
//     {
//         dataitem("Company Information"; "Company Information")
//         {
//             column(Company_Name; "Company Information".Name) { }
//         } // end of dataitem company info teszt

//         dataitem("Production Order"; "Production Order")
//         {
//             column(WorkOrderNumber; "Production Order"."No.") { }

//             column(WOItemNumber; "Production Order"."Source No.") { }
//             column(WOQty; "Production Order".Quantity) { }
//             column(WORoutingNo; "Production Order"."Routing No.") { }
//             column(WOIdtemDesc; "Production Order"."Description") { }
//             column(KeyProdOrderStatus; Status) { }
//             column(WOLocation_Code; "Location Code") { }
...
//                 column(SEI_Order_Promising_Cust__No_; "SEI Order Promising Cust. No.") { }
//                 column(SEI_Order_Promising_SAP_No_; "SEI Order Promising SAP No.") { }

//                 trigger OnAfterGetRecord()
//                 begin
//                     //"Prod. Order Line".SetRange("Prod. Order No.", RQP_WONumber);
//                 end;
//             }
//             dataitem(ProductionBOMComponents; "Prod. Order Component")
//             {
//                 DataItemLink = "Prod. Order No." = field("No.");

//                 column(RMItemNumber; "Item No.") { }
//                 column(RMItemDesc; Description) { }
//                 column(RMItemUnit; "Unit of Measure Code") { }
//                 column(RMItemBOMQty; "Quantity per") { }
//                 column(KeyProdOrderCompStatus; Status) { }
//                 column(KeyProdOrderCompProdOrderNo; "Prod. Order No.") { }
//                 column(KeyProdOrderCompProdOrderLineNo; "Prod. Order Line No.") { }
//                 column(KeyProdOrderCompLineNo; "Line No.") { }
...
//                 end;
//             } // end of prod order component

//             dataitem("Prod. Order Routing Line"; "Prod. Order Routing Line")
//             {
//                 DataItemLink = "Prod. Order No." = field("No.");
//                 DataItemTableView = SORTING("Operation No.");
//                 column(ProdOrderRoutingNumber; "Prod. Order Routing Line"."No.") { }
//                 column(ProdOrderRoutingName; "Prod. Order Routing Line".Description) { }
//                 column(BarCodeRoutingCode; C128RoutingNumber.Picture) { }
//                 column(KeyRoutingLineNo; "Routing No.") { }
//                 column(KeyRoutingRefNo; "Routing Reference No.") { }
//                 column(KeyRoutingOperationNo; "Operation No.") { }

//                 trigger OnPreDataItem()
//                 begin
//                     //"Prod. Order Routing Line".SetRange("Prod. Order No.", RQP_WONumber);
//                 end;

//                 trigger OnAfterGetRecord()
//                 begin
//                     C128RoutingNumber.Init();
//                     C128MakeBarcode(Format("Operation No."), C128RoutingNumber, 3000, 1000, 96, false);
//                 end;

//             } //prodorder routing line
//             dataitem("Comment Line"; "Comment Line")
//             {
//                 DataItemLink = "No." = field("Source No.");
//                 column(CommentItem; "No.") { }
//                 column(CommentComment; Comment) { }
//                 column(CommentDate; Date) { }

//                 trigger OnPreDataItem()
//                 begin
//                     "Comment Line".SetRange("No.");
//                 end;
//             }

//             trigger OnPreDataItem()
//             begin
//                 //"Production Order".SetRange("No.", RQP_WONumber);
//             end;

//             trigger OnAfterGetRecord()
//             begin
//                 //CompInfoItemNo.Init();
//                 //C128MakeBarcode(Format("Prod. Order Routing Line"."Prod. Order No."), CompInfoItemNo, 3000, 1000, 96, false);
//                 // if RQP_WONumber <> '' then begin
//                 //     "Production Order".SetFilter("No.", '=%1', RQP_WONumber);
//                 // end else begin
//                 //     //"Production Order".SetFilter("No.", '=%1', RQP_WONumber);
//                 // end;
//                 C128WONumber.Init();
...
//             //     {
//             //         Caption = 'Setup';
//             //         field(RQP_WONumber; RQP_WONumber)
//             //         {
...
//         LblPage = 'Page :';
//         LblWorkOrderNumber = 'Work order number :';
//         LblWorkOrderItemNumber = 'Item Number :';
//         LblWorkOrderQty = 'Quantity';
//         LblRMItemNumber = 'Raw material item number';
//         LblRMItemDesc = 'Raw material description';
//         LblRMItemUnit = 'Raw mat. unit';
//         LblRMItemQty = 'Raw mat. BOM qty.';
//         LblRMItemrequired = 'Raw mat. req.';
//         LblRMItemRealConsumption = 'Actual consumption';
//         LblRMItemScrapqty = 'Scrap';
//         LblRMItemLOTNumber = 'LOT number';
//         LblroutingGoodQty = 'Good qty.';
//         LblRoutingOperationTime = 'Operation time';
//         LblRoutingDate = 'Date';
//         LblRoutingOperator = 'Operator name';
//         LblRoutingStopTime = 'Stop time';
//         LblRoutingStopCode = 'Stop code';
//         LblRoutingShiftCode = 'Shift code';
//         LblRoutingMachineNumber = 'Machine';
//         LblRoutingScrapRegistration = 'Scrap registration area';
//         LblRoutingScrapQty = 'Scrap qty';
//         LblRoutingScrapCode = 'Scrap code';
//         LblWOItemDesc = 'Desc.';
//         LblWO = 'WO number';
//         LblComment = 'Description';
//         LblCustomerReferenceNr = 'Customer reference number';
//         LblCustomerName = 'Customer name';
//         LblCustomerNr = 'Customer number';
//         LblSAPOrderNumber = 'SAP Order number';

//     } //end of labels

//     var
//         RQP_WONumber: Code[20];
//         WONumberBarcode: Text;
//         Routing: Record "Prod. Order Routing Line";
//         Message: Text;
