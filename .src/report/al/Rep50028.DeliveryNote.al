report 50028 "SEI Delivery Note"
{
    Caption = 'SEI Delivery Note', Locked = true;

    ApplicationArea = All;
    UsageCategory = ReportsAndAnalysis;
    DefaultLayout = RDLC; //RDLC VS megnyitása csakkor lesz jó, ha van adatforrás
    RDLCLayout = '.src/report/rdlc/Rep50028.Delivery Note.rdlc';
    ...
    dataset
    {
        dataitem("Warehouse Shipment Header"; "Warehouse Shipment Header")
        {
            ...
            dataitem("Warehouse Shipment Line"; "Warehouse Shipment Line")
            {
                ...
                trigger OnPreDataItem()
                begin
                    "Warehouse Shipment Line".SetFilter("Warehouse Shipment Line"."No.", "Warehouse Shipment Header"."No.");
