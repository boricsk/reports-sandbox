...
report 50099 "SEI Travel ticket"
{
    Caption = 'Travel ticket';
    ApplicationArea = All;
    UsageCategory = ReportsAndAnalysis;
    DefaultLayout = RDLC;
    RDLCLayout = '.src/report/rdlc/rep50099.travel-ticket.rdlc';
    ...
    dataset
    {
        ...
        //itt a production order táblából nem kell adat ugyan, de a form ide adja át a WO-számot.
        {
            ...
            dataitem("SEI Package"; "SEI Package")
            {
                DataItemLink = "Document No." = field("No.");

                column(Document_No_; "Document No.") { }
                column(Packaging_Date; "Packaging Date") { }
                column(Item_No_; "Item No.") { }
                column(Finished_Quantity; "Finished Quantity") { }
                column(Unit_of_Measure_Code; "Unit of Measure Code") { }
                column(Lot_No_; "Lot No.") { }
                column(C128LotNumber; C128LotNumber.Picture) { }

                trigger OnAfterGetRecord()
                begin

                    C128LotNumber.Init();
                    C128MakeBarcode(Format("SEI Package"."Lot No."), C128LotNumber, 3000, 1000, 96, false);
                end;
            }
    ...
    labels
    {
        LblTitle = 'TERMÉKKISÉRŐ CIMKE / PRODUCT LABEL', Locked = true;
        LblDate = 'Dátum / Date', Locked = true;
        LblItem = 'Cikkszám / Item number', Locked = true;
        LblLOT = 'LOT szám / LOT number', Locked = true;
        LblQty = 'Mennyiség / Quantity', Locked = true;

    }//labels
    var
        ProductionJrnlMgt: Codeunit "Production Journal Mgt";
        C128Bars: array[107] of Text[13];
        C128LotNumber: Record "Company Information";
