report 50098 "SEI Order Confirmation"
{
    RDLCLayout = '.src/report/rdlc/rep50098.OrderConfirmation.rdlc';
    //WordLayout = './StandardSalesOrderConf.docx';
    Caption = 'SEI Order Confirmation', Locked = true;
    DefaultLayout = RDLC;
    ...
    dataset
    {
        dataitem(Header; "Sales Header")
        {
            ...
            column(SEI_SAP_PO_No_; "SEI SAP PO No.")
            {
            ...
            begin
                ...
                CurrReport.Language := Language_.GetLanguageIdOrDefault("Language Code");
    ...
    var
        ...
        CustRefNoLbl: Label 'Customer reference no.';
